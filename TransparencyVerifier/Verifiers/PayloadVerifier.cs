...
/// <summary>
/// Bài kiểm tra 5: Đối chiếu payload nhật ký bấm với nội dung bộ bài tại vị trí tương ứng.
/// Với mỗi lượt bấm: deck[round].tickets[position] phải == step.payload.
/// </summary>
public static class PayloadVerifier
{
    ...
    public static Result Verify(List<DeckInfo> decks, List<DrawStep> steps)
    {
        ...
        // Nhóm steps theo round để đối chiếu với từng deck
